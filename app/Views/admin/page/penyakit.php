				...
				<div class="page-inner">
					<div class="page-header">
						...
						<ul class="breadcrumbs">
							...
							<li class="nav-item">
								<a href="/admin/datapenyakit">Data Penyakit</a>
							</li>
						</ul>
					</div>
					<div class="row">
							...
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title"><b>Data Penyakit</b></h4>
														...
														<div class="row">
															<div class="col-sm-12">
																<div class="form-group form-group-default">
																	<form action="datapenyakit/store" method="POST">
                                                                    <?= csrf_field() ?>
																	<div>
																	<label>Kode Penyakit</label>
																	<input type="text" class="form-control" value="<?= $kode?>" name="kode_penyakit" placeholder="masukan kode penyakit" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;" readonly>
																	<br>
									...
									<div class="table-responsive">
										<table id="add-row" class="display table table-striped table-hover" >
											...
											<tbody>
                                                ...
                                                <?php $row=1; foreach($datapenyakit as $data):?>
												<tr>
													<td><?= $row++;?></td>
													...
													<td>
														<div class="form-button-action">
															<button type="button" data-toggle="modal" data-original-title="Edit"  title="" data-target="#updateRowModal<?= $data['id']?>" class="btn btn-link btn-warning btn-lg" data-original-title="Edit Task">
																		...
																		<div class="modal-content">
																			...
																			<div class="modal-body">
																					<div class="row">
																						<div class="col-sm-12">
																							<div class="form-group form-group-default">
																								<form action="<?= base_url('admin/datapenyakit/update/'.$data['id'])?>" method="POST">
                                                                                                <input type="hidden" name="_method" value="PUT">
																								
																								<div>
																								<label>Kode Penyakit</label>
																								<input type="text" class="form-control"  value="<?=$data['kode_penyakit'];?>" name="kode_penyakit" placeholder="masukan kode penyakit" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;" readonly>
																								<br>
																								<label>Nama Penyakit</label>
																								...
																								<br>
																								<label>Deskripsi Penyakit</label>
																								<textarea name="deskripsi" class="form-control" id="" cols="30" rows="10" value="<?=$data['deskripsi'];?>" style="border: 1px solid #f1f1f1; padding-left:10px;"><?=$data['deskripsi'];?></textarea>
																								<br>
															...
															<form action="<?=base_url('admin/datapenyakit/delete/'.$data['id'])?>" method="POST">
																<?php csrf_field();?>

        ...
        <div class="content">
            <div class="page-inner">
                <div class="page-header">
                    <h4 class="page-title"><b>Data Solusi</b></h4>
                    <ul class="breadcrumbs">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('/admin/datasolusi') ?>">Data Solusi</a>
                        </li>
                    </ul>
                </div>
                <div class="row">
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header no-bd">
                                                <h5 class="modal-title">
                                                    <span class="fw-mediumbold">Tambahkan</span> 
                                                    <span class="fw-light">Solusi</span>
                                                </h5>
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="form-group form-group-default">
                                                            <form action="<?= base_url('admin/datasolusi/store') ?>" method="POST">
                                                                <?= csrf_field() ?>
                                                                <div>
                                                                    <label>Kode Solusi</label>
                                                                    <input type="text" class="form-control" name="kode_solusi" placeholder="masukan kode solusi" value="<?= $kode ?>" style="border: 1px solid #f1f1f1; line-height:40px; padding-left:10px;" readonly>
                                                                    <br>
                                                                    <label>Solusi</label>
                                ...
                                <div class="table-responsive">
                                    <table id="add-row" class="display table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php $row=1; foreach ($datasolusi as $data): ?>
                                                <tr>
                                                    <td><?= $row++; ?></td>
                                                    ...
                                                    <td>
                                                        <div class="form-button-action">
                                                                    ...
                                                                    <div class="modal-content">
                                                                        ...
                                                                        <div class="modal-body">
                                                                            <div class="row">
                                                                                <div class="col-sm-12">
                                                                                    <div class="form-group form-group-default">
                                                                                        <form action="<?= base_url('admin/datasolusi/update/' . $data['id']) ?>" method="POST">
                                                            ...
                                                            <form action="<?= base_url('admin/datasolusi/delete/' . $data['id']) ?>" method="POST">
                                                                <?= csrf_field() ?>
